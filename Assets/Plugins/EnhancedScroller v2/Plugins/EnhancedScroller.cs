...
namespace EnhancedUI.EnhancedScroller
{
    ...
    /// <summary>
    /// This delegate handles the change in state of the scroller (dragging or not dragging)
    /// </summary>
    /// <param name="scroller">The scroller that changed state</param>
    /// <param name="scrolling">Whether or not the scroller is dragging by finger</param>
    public delegate void ScrollerDraggingChangedDelegate(EnhancedScroller scroller, bool dragging);
    ...
    public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler
    {
        ...
        /// <summary>
        /// This delegate is called when the scroller has started or stopped dragging by human
        /// </summary>
        public ScrollerDraggingChangedDelegate scrollerDraggingChanged;
		...
		public void OnBeginDrag(PointerEventData data)
		{
            ...
            if (scrollerDraggingChanged != null) scrollerDraggingChanged(this, true);
        }
		...
		public void OnEndDrag(PointerEventData data)
		{
            ...
            if (scrollerDraggingChanged != null) scrollerDraggingChanged(this, false);
		}
